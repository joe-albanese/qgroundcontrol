...
Rectangle {
    ...
    property bool   _isRTSP:                    _isGst && _videoSource === _videoSettings.rtspVideoSource || _videoSource === _videoSettings.obscuraVideoSource || _videoSource === _videoSettings.z3VideoSource || _videoSource === _videoSettings.wirisVisibleVideoSource || _videoSource === _videoSettings.wirisThermalVideoSource
